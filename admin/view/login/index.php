...
<div id="login-bg">
	<img src="<?php echo siteUrl('image/admin_login_bg.png');?>">
</div>
<div class="login-box">
	...
	<form class="relative" style="padding-top: 50px;">
		...
		<div class="mt20">
			...
			<img id="refresh" class="left pointer ml10" height="34" width="80" src="<?php echo url('login/loginCode');?>" onclick="document.getElementById('refresh').src='<?php echo url('login/loginCode');?>'" title="换一张">
			<div class="clear"></div>
		</div>
